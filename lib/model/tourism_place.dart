...
var tourismPlaceList = [
  TourismPlace(
    ...
    imageAsset: 'aassets/farm-house.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'aassets/bosscha.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'aassets/jalan-asia-afrika.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'aassets/stone-garden.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'aassets/taman-film.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'aassets/museum-geologi.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 20000',
    imageAsset: 'aassets/floating-market.png',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'aassets/kawah-putih.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Rp 20000',
    imageAsset: 'aassets/ranca-upas.jpg',
    imageUrls: [
